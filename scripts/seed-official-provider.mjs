...
const CATEGORY_SERVICES = [
  ...
  // ELECTRICAL SERVICES (ID: 212)
  { categoryId: 212, name: "Electrical Panel Upgrade", serviceType: "mobile", pricingModel: "fixed", basePrice: "1200.00", durationMinutes: 480, description: "Upgrade your electrical panel to handle modern power demands safely." },
  { categoryId: 212, name: "Outlet & Switch Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "150.00", durationMinutes: 60, description: "Install new outlets, switches, or upgrade existing ones including GFCI and USB outlets." },
  { categoryId: 212, name: "Ceiling Fan Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "180.00", durationMinutes: 90, description: "Install or replace ceiling fans with proper wiring and mounting." },
  { categoryId: 212, name: "Recessed Lighting Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "250.00", durationMinutes: 120, description: "Install recessed LED lighting for modern, clean illumination." },
  { categoryId: 212, name: "Whole-Home Rewiring", serviceType: "mobile", pricingModel: "fixed", basePrice: "3500.00", durationMinutes: 1440, description: "Complete rewiring for older homes to meet current electrical codes." },
  { categoryId: 212, name: "EV Charger Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "600.00", durationMinutes: 180, description: "Install Level 2 electric vehicle charging station in your garage or driveway." },
  { categoryId: 212, name: "Generator Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "800.00", durationMinutes: 240, description: "Install whole-home or portable generator with transfer switch." },
  { categoryId: 212, name: "Electrical Troubleshooting", serviceType: "mobile", pricingModel: "fixed", basePrice: "120.00", durationMinutes: 60, description: "Diagnose and repair electrical issues including flickering lights, tripped breakers, and dead outlets." },
  { categoryId: 212, name: "Landscape & Outdoor Lighting", serviceType: "mobile", pricingModel: "fixed", basePrice: "350.00", durationMinutes: 180, description: "Design and install outdoor lighting for pathways, patios, and landscaping." },
  { categoryId: 212, name: "Smoke & CO Detector Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "100.00", durationMinutes: 45, description: "Install or replace hardwired smoke and carbon monoxide detectors." },
  { categoryId: 212, name: "Electrical Safety Inspection", serviceType: "mobile", pricingModel: "fixed", basePrice: "200.00", durationMinutes: 90, description: "Comprehensive inspection of your home's electrical system for safety and code compliance." },
  { categoryId: 212, name: "Smart Home Wiring", serviceType: "mobile", pricingModel: "fixed", basePrice: "300.00", durationMinutes: 120, description: "Wire your home for smart switches, thermostats, doorbells, and automation systems." },
  // HVAC (ID: 213)
  { categoryId: 213, name: "AC Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "3000.00", durationMinutes: 480, description: "Install new central air conditioning system or replace existing unit." },
  { categoryId: 213, name: "AC Repair", serviceType: "mobile", pricingModel: "fixed", basePrice: "250.00", durationMinutes: 120, description: "Diagnose and repair AC issues including no cooling, strange noises, and refrigerant leaks." },
  { categoryId: 213, name: "Furnace Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "2800.00", durationMinutes: 480, description: "Install new gas or electric furnace for reliable home heating." },
  { categoryId: 213, name: "Furnace Repair", serviceType: "mobile", pricingModel: "fixed", basePrice: "250.00", durationMinutes: 120, description: "Diagnose and repair furnace problems including no heat, short cycling, and ignition failures." },
  { categoryId: 213, name: "HVAC Maintenance & Tune-Up", serviceType: "mobile", pricingModel: "fixed", basePrice: "150.00", durationMinutes: 90, description: "Seasonal maintenance to keep your HVAC system running efficiently and prevent breakdowns." },
  { categoryId: 213, name: "Ductwork Installation & Repair", serviceType: "mobile", pricingModel: "fixed", basePrice: "500.00", durationMinutes: 240, description: "Install new ductwork or repair leaky, damaged ducts for better airflow." },
  { categoryId: 213, name: "Heat Pump Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "3500.00", durationMinutes: 480, description: "Install energy-efficient heat pump for year-round heating and cooling." },
  { categoryId: 213, name: "Thermostat Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "120.00", durationMinutes: 45, description: "Install smart or programmable thermostat for better climate control and energy savings." },
  { categoryId: 213, name: "Mini-Split Installation", serviceType: "mobile", pricingModel: "fixed", basePrice: "2000.00", durationMinutes: 360, description: "Install ductless mini-split system for targeted heating and cooling in specific rooms." },
