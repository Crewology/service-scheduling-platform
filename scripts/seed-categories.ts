...
const categories = [
  ...
  { id: 148, name: "POWER WASHING & EXTERIOR CLEANING", slug: "power-washing-exterior-cleaning", description: "Power washing and exterior cleaning", isMobileEnabled: true, isFixedLocationEnabled: false, isVirtualEnabled: false, sortOrder: 37 },
  { id: 26, name: "RESERVATION BOOKING", slug: "reservation-booking", description: "Reservation and booking services", isMobileEnabled: false, isFixedLocationEnabled: true, isVirtualEnabled: true, sortOrder: 38 },
  { id: 215, name: "ROOFING SERVICES", slug: "roofing-services", description: "Professional roofing services including inspection, repair, replacement, and maintenance", isMobileEnabled: true, isFixedLocationEnabled: true, isVirtualEnabled: false, sortOrder: 39 },
