      ...
      <div className="flex-1 container py-6 sm:py-10 max-w-3xl">
        ...
        {isProviderView && user?.role === "provider" && (!providerProfile || !providerProfile.stripeOnboardingComplete) && (
          <Link href="/provider/onboarding">
            <div className="mb-6 px-4 py-3 rounded-lg border bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 cursor-pointer hover:shadow-sm transition-shadow">
