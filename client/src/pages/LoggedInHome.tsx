...
const PROVIDER_TILES: LaunchpadTile[] = [
  ...
  { label: "Analytics", icon: <BarChart3 className="h-7 w-7" />, href: "/provider/analytics", color: "bg-amber-100", iconColor: "text-amber-600" },
...
const CUSTOMER_TILES: LaunchpadTile[] = [
  ...
  { label: "Quotes", icon: <FileText className="h-7 w-7" />, href: "/my-quotes", color: "bg-indigo-100", iconColor: "text-indigo-600" },
