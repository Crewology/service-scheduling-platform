...
Browse our 43+ service categories and book your first appointment today.
...
You now have access to **43+ service categories** — from barbers and massage therapists to DJs, photographers, handymen, personal trainers, and much more. Every provider on our platform is vetted with our **Trust Score** system, so you can book with confidence.
...
The OlogyCrew Team
      `.trim(),
      smsBody: `Welcome to OlogyCrew! Browse 43+ service categories and book your first appointment today.`,
    },
