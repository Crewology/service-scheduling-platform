...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "OlogyCrew supports 43+ service categories including Barber Shop, Salon, Massage Therapist, Personal Trainer, Handyman, Photography, DJ & Music, Event Planning, Home Cleaning, Auto Detailing, Tech Support, Cybersecurity, Dance Lessons, Pet Care, and many more.",
    category: "General",
  },
  {
              ...
              <Card className="hover:shadow-md transition-all cursor-pointer h-full">
                <CardContent className="flex items-center gap-3 py-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Explore 43+ categories</p>
                  </div>
                </CardContent>
              </Card>
            </Link>
