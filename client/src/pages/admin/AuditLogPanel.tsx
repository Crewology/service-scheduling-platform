...
const ACTION_LABELS: Record<string, string> = {
  ...
  verify_provider: "Legacy Provider Verification",
  reject_provider: "Legacy Provider Rejection",
  verification_document_submitted: "Submitted Verification Evidence",
  verification_document_approved: "Approved Verification Evidence",
  verification_document_rejected: "Rejected Verification Evidence",
  verification_document_revoked: "Revoked Verification Evidence",
  verification_document_deleted: "Deleted Unreviewed Evidence",
