...
export const serviceRouter = router({
  create: protectedProcedure
    .input(z.object({
      ...
      serviceType: z.enum(["mobile", "fixed_location", "virtual", "hybrid", "flexible", "teams", "zoom"]),
  ...
  update: protectedProcedure
    .input(z.object({
      ...
      description: z.string().optional(),
      categoryId: z.number().optional(),
      serviceType: z.enum(["mobile", "fixed_location", "virtual", "hybrid", "flexible", "teams", "zoom"]).optional(),
